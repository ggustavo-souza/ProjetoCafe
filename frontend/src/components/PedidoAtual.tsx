...
export default function PedidoAtual({ mesa, itens }: PedidoAtualProps) {
    ...
    if (expandir) {
        return (
            <div className="fixed inset-0 z-50 transition bg-white flex flex-col p-6 animate-fade-in">
                ...
                {/* Rodapé da Tela Cheia (Total e Finalizar) */}
    ...
    // Renderização Compacta (Rodapé)
    return (
        <div className="p-4 fixed bottom-0 left-0 w-full transition bg-white shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.1)] ring-1 ring-gray-300 rounded-t-2xl z-40">
