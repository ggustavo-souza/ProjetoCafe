...
export default function CardapioEditar() {
    ...
    return (
        <>
            ...
            <main>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mt-10 gap-6 justify-center me-10 ms-10">
                    {produtos.map((produto: Produto) => (
                        <div key={produto.id} className="shadow-xl w-sm rounded-xl overflow-hidden">
                            <img
                            ...
                            <div className="p-10">
                                ...
                                <button className="cursor-pointer hover:bg-blue-600 p-3 bg-blue-500 rounded-md mt-4 w-full text-white">
                                    <i className="bi bi-pencil me-3"></i>Editar Item
                                </button>
                                <button className="cursor-pointer hover:bg-blue-500 hover:text-white p-3 border-2 border-blue-500 rounded-md mt-4 w-full text-blue-500">
